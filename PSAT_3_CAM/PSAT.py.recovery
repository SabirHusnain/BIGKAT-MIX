...
def load_demo_images():
    ...
    master_frame = cv2.imread(os.path.join(base_path, 'artwork', 'master_img.tif'))
    right_frame = cv2.imread(os.path.join(base_path, 'artwork', 'right_img.tif'))
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def find_participant(self):
        ...
        if self.participant_list_loaded:
            ...
            if N_entries == 0:
                ...
                part_markerNum = int(self.participant_list.loc[self.current_entry_index]['Markers'])
    ...
    def start_recording(self):
        ...
        self.backend_camera.TCP_client_start_UDP(
            t, os.path.join(self.storage_loc, 'testIR.h264'))  # Starts the video recording
